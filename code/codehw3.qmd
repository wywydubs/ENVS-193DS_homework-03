...
via a gradient with a ghoulish creature on one side with sharp jagged 
surroundings to represent waking up with an alarm and a calm peaceful gnome with 
smooth features and backround to represent waking up naturally, with similar wake 
up times and times to get out of bed I used some  reference photos for the 
...
backround and then drawing on it using the app. 
